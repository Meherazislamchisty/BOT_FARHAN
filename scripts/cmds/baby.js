...
module.exports.onChat = async ({
    ...
    try {
        ...
        if (body.startsWith("baby") || body.startsWith("bby") || body.startsWith("bot") || body.startsWith("jan") || body.startsWith("babu") || body.startsWith("oi")) {
            ...
            const rawReplies = [
  "How Can I help you 😒🌷","আমাকে না ডেকে 𝙈𝙚𝙝𝙚𝙧𝙖𝙯 কে ডাক 🐺🚩","আমি CHISTYr এর সাথে ব্যস্ত আছি 🙈👀🌊","তুমি বলে ফুন্দেদি ফল 🎀","Ajke amar mon valo nei 🤧🥴","তুমি বলে কান্দরা pro max 🙈😥","Kire তুমি সিটাইংগে না্ বইংগে 💀🌚","কিরে kawwa ডাহরকা 🌚🐦‍⬛" 
  ];
