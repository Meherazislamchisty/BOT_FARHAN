...
module.exports.onChat = async ({
    ...
    try {
        ...
        if (body.startsWith("baby") || body.startsWith("bby") || body.startsWith("bot") || body.startsWith("jan") || body.startsWith("babu") || body.startsWith("oi")) {
            ...
            const rawReplies = [
  "Can I help you 😒🌷","আমাকে না ডেকে 𝙈𝙚𝙝𝙚𝙧𝙖𝙯 কে ডাক 🐺🚩","আমি বস এর সাথে ব্যস্ত আছি 🙈👀🌊","তুমি বলে ফুন্দেদি ফল 🎀","এখন আমার মন ভালো না পরে কথা বলি 💗☺️","তুমি বলে কান্দরা + আগাফুসা 🙈😥","তুমি সিটাইংগে না্ বইংগে💀🌚","কিরে kawwa ডাহর কা্🌚🐦‍⬛"
];
